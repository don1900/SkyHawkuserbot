...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            " Please make sure your Heroku API Key, Your App name are configured correctly in the heroku\n\n[Visit Support Group For Help](https://t.me/SkyhawkSupport)"
        )
    Skyhawk_data = app.get_log()
    Skyhawk_key = (
        requests.post("https://nekobin.com/api/documents", json={"content": Skyhawk_data})
        .json()
        .get("result")
        .get("key")
    )
    Skyhawk_url = f"⚡ Pasted this logs.txt to [NekoBin](https://nekobin.com/{Skyhawk_key}) && [RAW PAGE](https://nekobin.com/raw/{Skyhawk_key}) ⚡"
