...
@SkyhawkBot.on(admin_cmd(pattern="sin ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="cos ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="tan ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="cosec ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="sec ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="cot ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="square ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="cube ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
