...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](SkyhawkNetwork/SkyhawkBot)**",
        ...
        "__INFO:SkyhawkBot:Logged in as 557667062__",
        "__INFO:SkyhawkBot:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
