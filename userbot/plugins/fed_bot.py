...
from SkyhawkBot.Config import Config
from SkyhawkBot.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@SkyhawkBot.on(admin_cmd(pattern="fban ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@SkyhawkBot.on(admin_cmd(pattern="unfban ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@SkyhawkBot.on(admin_cmd(pattern=r"fadd ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern=r"fremove ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="fgroups"))
@SkyhawkBot.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="fsearch ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@SkyhawkBot.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@SkyhawkBot.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {Skyhawk_input}")
...
@SkyhawkBot.on(admin_cmd(pattern="renamefed ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    Skyhawk_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {Skyhawk_input}")
              response = await response 
          except YouBlockedUserError: 
...
@SkyhawkBot.on(admin_cmd(pattern="fstat ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    Skyhawk = await event.edit("`Collecting fstat....`")
    thumb = Skyhawk_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await SkyhawkBot.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using SkyhawkBot](t.me/SkyhawkUserbot) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await Skyhawk.edit("`Please Unblock` @MissRose_Bot")


@SkyhawkBot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@SkyhawkBot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    Skyhawk = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await Skyhawk.edit(massive.text + "\n\n**LEGENDARY_AF_SkyhawkBot**")
        except YouBlockedUserError:
            await Skyhawk.edit("`Please Unblock` @MissRose_Bot")
