...
async def _(event):
    ...
    process = await asyncio.create_subprocess_sSkyhawk(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [SkyhawkBot](t.me/SkyhawkUserbot) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your SkyhawkBot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of SkyhawkBot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your SkyhawkBot server'
).add_command(
