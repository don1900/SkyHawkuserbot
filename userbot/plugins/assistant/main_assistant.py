...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your SkyHawk 🦅", data="deploy")],
                [Button.url("Help Me ❓", "https://t.me/SkyHawkSupport")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy Skyhaw In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [Button.url("Deploy Tutorial 📺", "https://t.me/SkyHawkSupport")],
                [Button.url("Need Help ❓", "https://t.me/SkyHawkSupport")],
            ],
        )
