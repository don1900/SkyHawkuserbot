...
BOT_IS_UP_TO_DATE = "**The SkyhawkBot** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your SkyhawkBot ..."
)
...
RESTARTING_APP = "re-starting your application"
# -- Constants End -- #
