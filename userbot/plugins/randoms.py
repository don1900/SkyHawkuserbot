...
async def _(event):
    ...
    if x == 11:
        await event.edit(
            "🎶 Say, go through the Skyhawkest of days \n Heaven's a heartbreak away \n Never let you go, never let me down \n Oh, it's been a hell of a ride \n Driving the edge of a knife. \n Never let you go, never let me down \n \n Don't you give up, nah-nah-nah \n I won't give up, nah-nah-nah \n Let me love you \n Let me love you 🎶 \n **-Let me Love You**"
        )
    if x == 12:
        await event.edit(
    ...
    if x == 30:
        await event.edit(
            "🎶 I miss the taste of a sweeter life \n I miss the conversation \n I'm searching for a song tonight \n I'm changing all of the stations \n I like to think that we had it all \n We drew a map to a better place \n But on that road I took a fall \n Oh baby why did you run away? \n \n I was there for you \n In your Skyhawkest times \n I was there for you \n In your Skyhawkest night 🎶 \n **-Maps**"
        )
    if x == 31:
        await event.edit(
...
async def _(event):
    ...
    if x == 15:
        await event.edit('`"The night is Skyhawk and full of terrors."`')
    if x == 16:
...
async def _(event):
    ...
    if x == 85:
        await event.edit(
            '`"When taking a taxi ALWAYS get a receipt even if you don\'t need one. That way if you happen to accidentally leave a Skyhawkbelonging behind you will have the company name and taxi number."`'
        )
    if x == 86:
        await event.edit(
